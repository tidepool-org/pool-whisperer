...
module.exports = (function() {
  ...
  env.userApi = {
    ...
    serverName: config.fromEnvironment('SERVER_NAME', 'pool-whisperer'),
  ...
  env.seagull = {
    ...
    serviceSpec: config.fromEnvironment("SEAGULL_SERVICE")
  };
  ...
  env.serviceName = config.fromEnvironment('SERVICE_NAME', 'pool-whisperer');
